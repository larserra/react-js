...
export const CartIcons = () => {
  return (<span style={{fontSize: '48px', color: 'green'}}><i className="fas fa-luggage-cart "></i></span>)}

export const RemoveIcons = () => {
  return (<span style={{fontSize: '1rem'}}><i className="fa-solid fa-trash-can"></i></span>)}

export const UpIcons = () => {
  return (<span style={{fontSize: '1rem'}}><i className="fa-solid fa-caret-up "></i></span>)}
